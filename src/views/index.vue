<template>
  <div class="bg">
    <div class="banner">
      <img src="../assets/img/img_index_logo.png" />
      <img class="leftstar" src="../assets/img/img_index_star.gif" />
      <img class="rightstar" src="../assets/img/img_index_star.gif" />
    </div>
    <div class="container">
      <div v-show="index==0" class="content1 animated bounceInLeft">
        <ul class="team">
        ...
        <div class="mcph">
          <img src="../assets/img/ico_index_mingcph.png" />
        </div>
        <div class="mctable">
          <table>
            <thead>
        ...
        <img class="liw_left" src="../assets/img/img_index_liw.gif" />
        <img class="liw_right" src="../assets/img/img_index_liw.gif" />
      </div>

      <div v-show="index==1" class="content2 animated bounceInRight">
        <div class="c2left">
          <img class="game" src="../assets/img/img_chus.png" v-if="dizhuOrder=='1'" />
          <img class="game" src="../assets/img/img_fus.png" v-if="dizhuOrder=='2'" />
          <img class="game" src="../assets/img/img_jues.png" v-if="dizhuOrder=='3'" />
        ...
        <div class="c2right">
          ...
          <img class="game" src="../assets/img/img_chus.png" v-if="rongyOrder=='1'" />
          <img class="game" src="../assets/img/img_jues.png" v-if="rongyOrder=='2'" />
        ...
        <img class="c2_liw_left" src="../assets/img/img_index_liw.gif" />
        <img class="c2_liw_right" src="../assets/img/img_index_liw.gif" />
      </div>
      ...
      <a :class="flag?'zant':'play'" @click="play()"></a>
